...
public class MPSG {
    ...
    String queryString = mpsgName + ";query:select person.name,person.gravity,person.preference from person where person.isBusy = \"yes\"";
	//String queryString = mpsgName + ";query:select person.isBusy,person.preference,person.gravity from person where person.name = \"testmpsgname1\"";
	...
	//String queryString = mpsgName + ";query:select person.gravity,person.magnetism from person where person.acceleration = \"fast\" and person.name = \"testmpsgname2\"";// ) or ( person.acceleration = \"fast\" and person.magnetism = \"positive\" )";
